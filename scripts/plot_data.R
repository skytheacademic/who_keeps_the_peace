...
# Save the first plot
ggsave("./results/job_talk/match_OR_slide1.pdf", plot1, width = 12, height = 8, units = "in")

# Save the second plot
ggsave("./results/job_talk/match_OR_slide2.pdf", plot2, width = 12, height = 8, units = "in")

###################################
# Job talk specific plots - END   #
###################################
